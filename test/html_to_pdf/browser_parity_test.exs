defmodule NativeElixirPdfUtilities.HtmlToPdf.BrowserParityTest do
  ...
  @fixture_thresholds [
    ...
    {"generated_content_counters.html", max_changed_ratio: 0.14, max_average_delta: 0.035},
    ...
    {"image_object_fitting.html", max_changed_ratio: 0.18, max_average_delta: 0.045},
    {"background_images.html", max_changed_ratio: 0.20, max_average_delta: 0.05},
    ...
    {"static_form_controls.html", max_changed_ratio: 0.20, max_average_delta: 0.05},
    ...
    {"table_column_layout.html", max_changed_ratio: 0.14, max_average_delta: 0.04},
  ...
  @real_document_fixture_thresholds [
    ...
    {"invoice_012.html",
     render_opts: [page_size: :a4],
     chromium_page_size: :a4,
     max_changed_ratio: 0.22,
     max_average_delta: 0.055},
    {"statement_012.html",
     render_opts: [page_size: :a4],
     chromium_page_size: :a4,
     max_changed_ratio: 0.22,
